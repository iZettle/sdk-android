...
You can integrate your point of sale (POS) with the `SDK` only for the supported markets, no matter where you are located. 
...
dependencies {
    implementation 'com.izettle.payments:android-sdk-ui:1.14.16'
}
```
